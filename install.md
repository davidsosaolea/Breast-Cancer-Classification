# Breast Cancer Classification guide installation
...
activate breast_cancer_classification
```
...
To move beyond notebook prototyping, all reusable code should go into the `breast_cancer_classification/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `breast_cancer_classification` folder and use the modules inside your notebooks :
...
```python
from breast_cancer_classification.utils.paths import data_dir
data_dir()
```
